 ...
 * @property semiPressedColor A color which is displayed when controls are semi-pressed (only used for simulations)
...
data class RadialGamePadTheme(
    ...
    val semiPressedColor: Int = Constants.DEFAULT_COLOR_PRESSED,
