...
object Constants {
    ...
    val DEFAULT_COLOR_NORMAL_STROKE = Color.TRANSPARENT
    val DEFAULT_COLOR_BACKGROUND_STROKE = Color.TRANSPARENT
    val DEFAULT_COLOR_LIGHT_STROKE = Color.TRANSPARENT
